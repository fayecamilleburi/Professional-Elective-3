...
# Function to apply 10% discount if  total exceeds PHP 500.00
def apply_discount(total_amount):
    discount_rate = 0.10  # 10%
    min_amount_for_discount = 500.0

    if total_amount > min_amount_for_discount:
...
# Main function to collect input item name and item price
def main():
    """
    Main function to run the grocery checkout simulation.
    """
    ...
    # Use a for loop to collect inputs dynamically based on num_items
